...
using QuadGK, Random, HCubature, Printf, Distributions
using Test

@testset "ExponentialExpectations.jl" begin
    ...
    function randomcoefficients()
        ...
        rand(rg)*1.0, randn(rg)*1.0, rand(rg)*2.0+1e-2, randn(rg)*1.0
            # a          μ             σ                b
    end
    ...
    for repeatindex in 1:repeats
        ...
        @printf("\n\n(%d) Randomly picked coefficients a, μ, σ, b are: %2.5f, %2.5f, %2.5f, %2.5f\n",repeatindex, a, μ, σ, b)
